  ...
  return (
    <>
      <div className='min-h-screen bg-slate-800 relative flex items-center justify-center p-4 overflow-hidden'>
        ...
        <div className="absolute top-0 -left-4 size-96 bg-pink-300 opacity-20 blur-[100px]" />
        <div className="absolute bottom-0 -right-4 size-96 bg-cyan-300 opacity-20 blur-[100px]" />
